    ...
    <header className="sticky top-0 z-50 bg-paper transition-all duration-300">
      ...
      <div
        className={`border-b border-ink-10 bg-paper transition-all duration-200 ${
          scrolled ? "py-2 shadow-nav" : "py-3"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          {/* Fit-to-Size Transparent Logo */}
          <Link href="/" className="flex items-center focus:outline-none focus:ring-2 focus:ring-electric rounded-lg py-1">
            <Image
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button
              ...
              className="bg-electric hover:bg-electric-dark text-white font-bold px-5 py-3 rounded-lg shadow-md hover:shadow-lg transition-all text-sm flex items-center gap-2 group"
            >
