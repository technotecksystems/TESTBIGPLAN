      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-widest text-electric block mb-2">
            Diverse Sector Expertise Across Canada
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-ink">
            Built for Every Canadian Business — Except Oil & Gas
          </h2>
          <p className="text-ink-70 text-base mt-3">
            From rural agricultural operations to urban tech founders and commercial real estate developers.
          </p>
        </div>
        ...
        <div className="mt-12 bg-ink-10/50 p-4 rounded-xl border border-ink-10 flex items-center gap-3 text-xs text-ink-70 max-w-2xl mx-auto">
          ...
          <span>
            <strong>Service Policy Note:</strong> We do not provide documentation services for oil & gas exploration, extraction, or related upstream projects.
          </span>
        </div>
      </div>
    </section>
